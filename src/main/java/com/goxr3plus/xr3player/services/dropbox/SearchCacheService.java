...
/**
 * The duty of this class is to Cache Dropbox Account Search so it is superior
 * fast :)
 * 
	...
	protected Task<Boolean> createTask() {
		return new Task<Boolean>() {
			...
			protected Boolean call() throws Exception {
				...
				Platform.runLater(
						() -> dropBoxViewer.getCachedSearchIndicator().getTooltip().setText("Preparing Cached Search"));
				...
				// Update Indicator Label
				Platform.runLater(() -> dropBoxViewer.getCachedSearchIndicator().getTooltip()
						.setText("Superior Cached Search is Enabled"));
