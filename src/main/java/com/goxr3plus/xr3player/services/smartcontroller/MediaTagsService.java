 ...
 * 
 * So for example when the user loads the Playlist only the basic information
 * will be added to the Media then this Service will be called and in the
...
public class MediaTagsService extends Service<Boolean> {
	...
	public void restartService(MediaTableViewer mediaTableViewer) {
		...
		mediaTableViewer.getSmartController().getDescriptionArea()
	...
	protected Task<Boolean> createTask() {
		return new Task<>() {
			...
			protected Boolean call() throws Exception {
				...
				if (operation == AllDetailsServiceOperation.ALL
						|| operation == AllDetailsServiceOperation.ARTWORK_COLUMN) {
					Platform.runLater(() -> mediaTableViewer.getSmartController().getDescriptionLabel()
							.setText("Finding album artwork..."));
