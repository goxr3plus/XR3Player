...
import main.java.com.goxr3plus.xr3player.application.xplayer.visualizer.presenter.MicrophoneVisualizer;
...
//						}
	...
	public static void checkMicrophoneAvailability() {
		...
		enumerateMicrophones().forEach((mixer, info) -> System.out
				.println("\nName : " + mixer.getName() + " , Description : " + mixer.getDescription() + " , Vendor : "
						+ mixer.getVendor() + " , Version : " + mixer.getVersion()));
	}
