 ...
 * 
 */
package main.java.com.goxr3plus.xr3player.application.tools.services;
...
public class PackZipService extends Service<Boolean> {
	...
	public void exportDataBase(String zipFile , String sourceFolder) {
		...
		setOnSucceeded(s -> {
			...
			// Check the Value
			if (getValue()) {
				ActionTool.showNotification("Zip Service", "Successfully create requested zip file :\n [ " + zipFile + " ]", Duration.seconds(3), NotificationType.SUCCESS);
			} else
