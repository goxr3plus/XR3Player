...
public class StreamPlayerEventLauncher implements Callable<String> {
     ...
     */
    public StreamPlayerEventLauncher(Object source, Status playerStatus, int encodedStreamPosition, Object description, List<StreamPlayerListener> listeners) {
        this.source = source;
    ...
    public String call() throws Exception {
        ...
        if (listeners != null) {
            listeners.forEach(listener -> listener.statusUpdated(new StreamPlayerEvent(source, playerState, encodedStreamPosition, description)));
        }
