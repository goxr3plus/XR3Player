...
public class DJMode extends GridPane {
	...
	public void initialize() {
		...
		Main.xPlayersList.getXPlayerUI(1).makeTheDisc(136, 136, Color.rgb(53, 144, 255), 35, Side.RIGHT);
		...
		Main.xPlayersList.getXPlayerUI(2).makeTheDisc(136, 136, Color.RED, 35, Side.LEFT);
