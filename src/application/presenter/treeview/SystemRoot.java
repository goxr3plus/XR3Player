...
public class SystemRoot {
	...
	public static final Image closedFolderImage = new Image(TreeItemFile.class.getResourceAsStream(InfoTool.IMAGES + "folder.png"));
	
	/** The Constant openedFolderImage. */
	public static final Image openedFolderImage = new Image(TreeItemFile.class.getResourceAsStream(InfoTool.IMAGES + "openedFolder.png"));
	
	/** The Constant fileImage. */
	public static final Image fileImage = new Image(TreeItemFile.class.getResourceAsStream(InfoTool.IMAGES + "file.png"));
	...
	public SystemRoot() {
		...
		TreeItemFile dekstop = new TreeItemFile(fileSystemView.getHomeDirectory().getAbsolutePath());
		root.getChildren().add(dekstop);
		
		// Add the root directories
		rootDirectories = FileSystems.getDefault().getRootDirectories();
		rootDirectories.forEach(pathName -> {
