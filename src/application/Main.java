...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        try {
            ...
            // rootStack
            stackPaneRoot.getChildren()
                .addAll(root, sideBar, updateScreen);
    ...
    public static void terminate(boolean vacuum) {
        ...
        if (libraryMode.multipleLibs.isFree(true)) {
            ...
            if (vacuum) {
                ...
                updateScreen.label.textProperty()
                    .bind(vService.messageProperty());
                updateScreen.progressBar.setProgress(-1);
                updateScreen.progressBar.progressProperty()
                    .bind(vService.progressProperty());
                updateScreen.setVisible(true);

                vService.start(new File(InfoTool.dbPath_With_Separator + "user" + File.separator + "dbFile.db"), new File(InfoTool.dbPath_With_Separator + "user" + File.separator + "dbFile.db-journal"));
                ...
                new Thread(() -> {
                    try {
                        ...
                        // vacuum
                        dbManager.connection1.createStatement()
